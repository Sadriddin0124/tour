...
const Contacts = ({ContactsData, Contacts}: {ContactsData: ContactsType[]; Contacts: {title: string, top: string, btn: string}}) => {
  return (
    <div className='w-[100%] min-h-[120vh] relative'>
      ...
      <div className='w-[100%] h-[70vh] flex flex-col justify-end items-center relative z-20 text-white gap-[50px]'>
        <h1 className='text-[20px] font-[500] relative'>{Contacts?.top} <span className=' left-[35%] top-[60px] absolute w-[100px] h-[2px] bg-gray-400'></span></h1>
        <h1 className='text-[50px] font-[700]'>{Contacts?.title}</h1>
        ...
        <div className='relative z-20 w-[100%] flex justify-center mt-[110px] gap-[25px]'>
            {
